  ...
  _createClass(Component, [{
    ...
    value: function _vDomPrototypeElementToHtmlElement(element) {
      ...
      if (typeof element === 'string') {
        var htmlElement = document.createElement('div'); // TODO: textNode
...
},{"../../framework/Component":13}],15:[function(require,module,exports) {
"use strict";
...
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
},{"./Temperature":19}],20:[function(require,module,exports) {
"use strict";
...
var Wind = function (_Component) {
  _inherits(Wind, _Component);

  function Wind(host, props) {
    _classCallCheck(this, Wind);

    return _possibleConstructorReturn(this, (Wind.__proto__ || Object.getPrototypeOf(Wind)).call(this, host, props));
  }
...
},{"../../framework/Component":13}],16:[function(require,module,exports) {
"use strict";
...
Object.defineProperty(exports, "Wind", {
  enumerable: true,
  get: function () {
    return _interopRequireDefault(_Wind).default;
  }
});

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
},{"./Wind":20}],11:[function(require,module,exports) {
"use strict";
...
var App = function (_Component) {
  ...
  function App(host) {
    ...
    return _possibleConstructorReturn(this, (App.__proto__ || Object.getPrototypeOf(App)).call(this, host));
  }
  ...
  _createClass(App, [{
    ...
    value: function render() {
      ...
      new _Temperature.Temperature(t1, { temperature: 25, unit: 'C' });

      var w1 = document.createElement('div');
      new _Wind.Wind(w1, { speed: 100500, unit: 'mph' });

      return ['Temperature range', t1, {
        ...
        children: [{ tag: 'div', content: 'Child 1' }, {
          tag: 'div',
          content: 'Child 2',
          children: [{ tag: 'div', content: 'Child 2.1' }, { tag: 'div', content: 'Child 2.2' }, { tag: _Temperature.Temperature, props: { temperature: 100, unit: 'K' } }]
...
exports.default = App;
},{"../../framework/Component":13,"../Temperature/":15,"../Wind":16}],7:[function(require,module,exports) {
"use strict";
...
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
},{"./App":11}],3:[function(require,module,exports) {
'use strict';

var _App = require('./Components/App/');

new _App.App(document.getElementById('app'));
},{"./Components/App/":7}],23:[function(require,module,exports) {
...
//# sourceMappingURL=/js.ca329ce5.map